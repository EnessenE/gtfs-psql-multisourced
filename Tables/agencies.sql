...
CREATE INDEX ix_agencies_id_data_origin
    ON public.agencies USING btree
...
CREATE INDEX ix_agencies_id_name
    ON public.agencies USING btree
...
CREATE INDEX ix_agencies_import_id_data_origin
    ON public.agencies USING btree
...
CREATE INDEX ix_agencies_internal_id
    ON public.agencies USING btree
